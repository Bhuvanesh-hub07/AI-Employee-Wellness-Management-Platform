"""
Independent held-out evaluation for the trained DistilBERT
emotion classifier.

This script evaluates DistilBERT on the independent held-out
dataset using:
- Accuracy
- Macro precision
- Macro recall
...
OUTPUT_PATH = Path(
    "outputs/distilbert_heldout_evaluation.csv"
)
...
def evaluate_heldout(
    ...
    """Evaluate DistilBERT on the independent held-out dataset."""
    ...
    print("\n" + "=" * 75)
    print("INDEPENDENT DISTILBERT HELD-OUT EVALUATION")
    print("=" * 75)
